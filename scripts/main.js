...
editPopup.querySelector('.popup__close-button').addEventListener('click', function () {  //закрытие
...
addPopup.querySelector('.popup__close-button').addEventListener('click', function () {      //закрытие
  closePopup(addPopup);
});
...
function addCard(linkValue, titleValue) {
  ...
  pictureElement.querySelector('.pictures__like-button').addEventListener('click', function (evt) {
